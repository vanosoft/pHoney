...
from parser import termui as t
from parser.parser import SHIFT, REDUCE, pos_to_line_col, Token
from parser.common import replace_newlines as _, position_context, dot_escape
from parser.trees import visitor, to_str, to_dot, Forest, NodeNonTerm, NodeTerm
...
class GLRParser(Parser):
    ...
    def _export__dot_trace(self):
        file_name = "{}_trace.dot".format(self.file_name) \
                    if self.file_name else "parser_trace.dot"
