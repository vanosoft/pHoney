...
import io
import logging
from parser.grammar import EMPTY, STOP
from parser.tables import LALR, SLR, SHIFT, REDUCE, ACCEPT
from parser.exceptions import (ParseError, ParserInitError,
                                 DisambiguationError,
                                 DynamicDisambiguationConflict, SRConflicts,
                                 RRConflicts, expected_symbols_str)
from parser.common import Location, position_context, pos_to_line_col, ErrorContext
from parser.trees import NodeTerm, NodeNonTerm
from parser.actions import pass_none
from parser.termui import prints, h_print, a_print
...
class Parser(object):
    ...
    def _call_shift_action(self, context):
        ...
        if self.build_tree:
            ...
            # https://github.com/igordejanovic/parser/issues/44
