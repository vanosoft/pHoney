...
import sys
import click
from parser import Grammar, ParseError, GrammarError, GLRParser, Parser
from parser.export import grammar_pda_export
from parser.tables import create_load_table
from parser.termui import prints, a_print, h_print
import parser.termui as t
...
@click.option('--no-colors', default=True, is_flag=True,
...
def pglr(ctx, debug, no_colors, prefer_shifts, prefer_shifts_over_empty):
    """
    Command line interface for working with parser grammars.
    """
